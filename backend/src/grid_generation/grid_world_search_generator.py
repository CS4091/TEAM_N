...
def generate_map():
    ...
    scale = 50.0
    threshold = 0.5  # Threshold for determining if noise value becomes an obstacle
    octaves = 3
    ...
    start_position = find_start_coordinate(grid)  # Find a clear starting position
    number_of_moves = int(grid.size * 0.4)

    return grid, start_position, number_of_moves
